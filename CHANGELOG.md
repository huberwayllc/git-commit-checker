...
All notable changes to `huberwaycms/git-commit-checker` will be documented in this file.
...
- Fix output render on Windows platform (https://github.com/huberwaycms/git-commit-checker/pull/10)
